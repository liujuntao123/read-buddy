---
id: "001"
title: "read-buddy Core Architecture & AI Companion Specification"
status: "closed"
blocked_by: []
...
`read-buddy` delivers a **Zero-Embedding, Chapter-First Desktop AI Reading Companion**:
...
4. **Behavioral Black-Box Tests**:
   - Prior art: existing Vitest unit and browser tests in `apps/read-buddy-app` (`vitest.config.mts`). All unit tests verify input-to-output behavior without mocking internal React hooks.
