...
export interface FoliateVendorView {
  ...
  /**
   * Continuous scrolled reading (read-buddy patch to the vendored paginator):
 ...
 * theme surfaces (read-buddy dark: #1D1D20, read-buddy-sepia: #FAF5EA, light:
...
export function getReaderThemeStyles(theme: ReaderTheme): string {
  ...
  if (theme === 'sepia') {
    // 链接色取护眼主题**自己的** accent（src/theme/read-buddy-sepia.css:
