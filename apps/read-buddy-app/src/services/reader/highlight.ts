 ...
 * article or a Foliate iframe document) in <mark.read-buddy-agent-highlight>
...
export const HIGHLIGHT_CLASS = 'read-buddy-agent-highlight';
/** How long the breathing animation runs before the marks fade out. */
export const HIGHLIGHT_DURATION_MS = 2_000;
const STYLE_ID = 'read-buddy-agent-highlight-style';

const HIGHLIGHT_CSS = `
@keyframes read-buddy-agent-breathe {
...
.${HIGHLIGHT_CLASS} {
  ...
  color: inherit;
  border-radius: 2px;
  animation: read-buddy-agent-breathe 1s ease-in-out 2;
