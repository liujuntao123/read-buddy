...
/**
 * read-buddy-sepia theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { readBuddySepiaTheme } from './read-buddy-sepia';
 *   import './read-buddy-sepia.css';
 */
export const readBuddySepiaTheme = {
  ...
  tokens: {
    ...
    "--color-background-surface": "light-dark(#FAF5EA, #FAF5EA)",
    "--color-background-body": "light-dark(#F3ECDD, #F3ECDD)",
    "--color-background-card": "light-dark(#FAF5EA, #FAF5EA)",
    "--color-background-popover": "light-dark(#FFFBF4, #362F26)",
    "--color-background-muted": "light-dark(#201B120D, #201B1280)",
    "--color-accent": "light-dark(#7B5802, #EFBF6D)",
    ...
    "--color-neutral": "light-dark(#201B121A, #EAE1D533)",
    ...
    "--color-text-primary": "light-dark(#201B12, #EAE1D5)",
    "--color-text-secondary": "light-dark(#4F4537, #B6A999)",
    "--color-text-disabled": "light-dark(#9B8F7F, #675D4E)",
    "--color-text-accent": "var(--color-accent)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#111111",
    "--color-on-accent": "light-dark(#FFFFFF, #482B00)",
    ...
    "--color-icon-primary": "light-dark(#201B12, #EAE1D5)",
    "--color-icon-secondary": "light-dark(#4F4537, #B6A999)",
    "--color-icon-disabled": "light-dark(#9B8F7F, #675D4E)",
    ...
    "--color-border": "light-dark(#201B121A, #F9EFE31A)",
    "--color-border-emphasized": "light-dark(#9B8F7F, #716758)",
    "--color-skeleton": "light-dark(#B6A999, #4F4537)",
    ...
    "--color-background-inverted": "light-dark(#201B12, #FFFBF4)",
    "--color-track": "light-dark(#B6A999, #4F4537)",
    "--radius-chat": "28px"
  },
  localTokens: {
  ...
  __localTokenLineage: ["neutral","read-buddy-sepia"],
  components: {
    "heading": {
      "level:1": {
