...
/**
 * read-buddy theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { readBuddyTheme } from './read-buddy';
 *   import './read-buddy.css';
 */
export const readBuddyTheme = {
  name: 'read-buddy',
  __built: true,
  tokens: {
    ...
    "--font-family-body": "-apple-system, \"Segoe UI\", Roboto, \"PingFang SC\", \"Hiragino Sans GB\", \"Microsoft YaHei\", sans-serif",
    "--font-family-heading": "Georgia, \"Songti SC\", \"STSong\", SimSun, serif",
    "--font-family-code": "\"\"SF Mono\"\", ui-monospace, Consolas, \"Cascadia Mono\", monospace",
    ...
    "--color-background-surface": "light-dark(#FFFFFF, #1D1D20)",
    "--color-background-body": "light-dark(#F7F6F3, #131315)",
    "--color-background-card": "light-dark(#FFFFFF, #1D1D20)",
    "--color-background-popover": "light-dark(#FAFCFF, #2A313A)",
    "--color-background-muted": "light-dark(#161C250D, #151C2580)",
    "--color-accent": "light-dark(#0062AA, #9CCAFF)",
    ...
    "--color-neutral": "light-dark(#161C251A, #DBE3F033)",
    "--color-overlay": "light-dark(#161C2566, #151C2599)",
    "--color-overlay-hover": "light-dark(#161C250D, #FFFFFF0D)",
    "--color-overlay-pressed": "light-dark(#161C251A, #FFFFFF1A)",
    "--color-text-primary": "light-dark(#161C25, #DBE3F0)",
    "--color-text-secondary": "light-dark(#3E4756, #A1ACBD)",
    "--color-text-disabled": "light-dark(#8891A2, #545F6E)",
    "--color-text-accent": "var(--color-accent)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#111111",
    "--color-on-accent": "light-dark(#FFFFFF, #003465)",
    ...
    "--color-icon-primary": "light-dark(#161C25, #DBE3F0)",
    "--color-icon-secondary": "light-dark(#3E4756, #A1ACBD)",
    "--color-icon-disabled": "light-dark(#8891A2, #545F6E)",
    ...
    "--color-border": "light-dark(#161C251A, #E9F1FE1A)",
    "--color-border-emphasized": "light-dark(#8891A2, #5E6978)",
    "--color-skeleton": "light-dark(#A2ACBD, #3D4856)",
    ...
    "--color-background-inverted": "light-dark(#161C25, #F9FCFF)",
    "--color-track": "light-dark(#A2ACBD, #3D4856)",
    "--radius-chat": "28px"
  },
  localTokens: {
  ...
  __localTokenLineage: ["neutral","read-buddy"],
  components: {
    "heading": {
      "level:1": {
  ...
  __axes: {
    "typography": {
      ...
      "body": {
        "family": "-apple-system",
        "fallbacks": "\"Segoe UI\", Roboto, \"PingFang SC\", \"Hiragino Sans GB\", \"Microsoft YaHei\", sans-serif"
      },
      "heading": {
        "family": "Georgia",
