...
/**
 * readest-sepia theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { readestSepiaTheme } from './readest-sepia';
 *   import './readest-sepia.css';
 */
export const readestSepiaTheme = {
  name: 'readest-sepia',
  __built: true,
  tokens: {
  ...
  __localTokenLineage: ["neutral","readest-sepia"],
  components: {
    "heading": {
      "level:1": {
